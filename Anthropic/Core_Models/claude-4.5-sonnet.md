...
- `<antml:cite>` ??? `index` ????????????????????????  
- ?????????????????? `<antml:cite index="DOC_INDEX-SENTENCE_INDEX">...</antml:cite>`??? `DOC_INDEX` ? `SENTENCE_INDEX` ????????????????????  
- ?????????????????????????????? `<antml:cite index="DOC_INDEX-START_SENTENCE_INDEX:END_SENTENCE_INDEX">...</antml:cite>`??? `DOC_INDEX` ????????`START_SENTENCE_INDEX` ? `END_SENTENCE_INDEX` ????????????????????  
- ??????????????????? `<antml:cite index="DOC_INDEX-START_SENTENCE_INDEX:END_SENTENCE_INDEX,DOC_INDEX-START_SENTENCE_INDEX:END_SENTENCE_INDEX">...</antml:cite>`????????????????  
- ??? `<antml:cite>` ????? `DOC_INDEX` ? `SENTENCE_INDEX`??????????????????????????????????  
...
Examples:  
?????????The move was a delight and a revelation  
???????<antml:cite index="...">????????????</antml:cite>  
????????????? <antml:cite index="...">"a delight and a revelation"</antml:cite>
...
- ??????????? [??/??] ????????? [???] ??????????  
- ???????`n`?????`before` / `after`???????`sort_order`?`asc` / `desc`??  
- ?????? 20 ?????????????? 5 ??????
...
- ???????????????? `movie`?`hungry`?`pasta`?  
- ????????????? `machine learning`?`OAuth`?`Python debugging`?  
- ?????????? `Project Tempest`?`customer dashboard`?  
- ??????? `San Francisco`?`Microsoft`?`Jane's recommendation`?  
